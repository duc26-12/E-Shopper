...
const Header = (props) => {
  const Qty = useSelector((state) => state.cart.countProduct);
      ...
      return (
        <li>
          <a onClick={handleLogout}>
            <i className="fa fa-lock">Logout</i>
          </a>
        </li>
      );
    } else {
  ...
  const renderQty = () => {
    const local = JSON.parse(localStorage.getItem("qty"));
    return <span className="Qty_product">{local}</span>;
  };
